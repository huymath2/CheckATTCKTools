...
..\Viettel\RegLastWriteTime.exe HKCU\Software\Microsoft\Office\11.0\Word\Security > "%sdir%\reg_Office_Security_LastWriteTime11.txt" 2>&1
..\Viettel\RegLastWriteTime.exe HKCU\Software\Microsoft\Office\12.0\Word\Security > "%sdir%\reg_Office_Security_LastWriteTime12.txt" 2>&1
..\Viettel\RegLastWriteTime.exe HKCU\Software\Microsoft\Office\14.0\Word\Security > "%sdir%\reg_Office_Security_LastWriteTime14.txt" 2>&1
..\Viettel\RegLastWriteTime.exe HKCU\Software\Microsoft\Office\15.0\Word\Security > "%sdir%\reg_Office_Security_LastWriteTime15.txt" 2>&1
..\Viettel\RegLastWriteTime.exe HKCU\Software\Microsoft\Office\16.0\Word\Security > "%sdir%\reg_Office_Security_LastWriteTime16.txt" 2>&1